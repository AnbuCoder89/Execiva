...
const ApproachSection: React.FC<ApproachSectionProps> = ({ caseStudy }) => {
  ...
  const linkItems = [
    {
      text: "View detailed methodology",
      href: "#methodology",
      icon: ArrowRight
    },
    {
      text: "Explore implementation process",
      href: "#implementation", 
      icon: ExternalLink
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <motion.h2 
                ...
                variants={itemVariants}
              >
                <span className="block font-medium">Our Approach</span>
              </motion.h2>
            </motion.div>
