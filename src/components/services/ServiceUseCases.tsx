      ...
      <div className="w-full flex">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden w-full flex flex-col md:flex-row">
          <div className="flex flex-col md:flex-row">
            ...
            {/* Right Side - Content */}
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-between h-[400px] md:h-[500px]">
              <div>
              ...
              {/* Tag at bottom */}
              <div>
                <span className="inline-block px-4 py-2 bg-green text-gray-900 rounded-full text-sm font-medium font-sf-pro-text border border-gray-200">
                  Website Redesign
                </span>
              </div>
            </div>
