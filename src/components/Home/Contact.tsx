...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://apidevelop.execiva.com/contact', {
        method: 'POST',
        body: formDataObj
      });
  ...
  const itemVariants: Variants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.8,
        ease: cubicBezier(0.25, 0.46, 0.45, 0.94) // ✅ TS-safe easing
      }
    }
  };
  ...
  return (
    <motion.section
      id="contact"
      className="relative w-full flex items-center justify-center bg-white py-20"
      ref={sectionRef}
      initial="hidden"
      whileInView="visible"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                GET IN
                <span className="block font-bold mt-2">TOUCH</span>
              </motion.h2>
              ...
              <motion.div className="mb-8" variants={itemVariants}>
                ...
                >
                  <p className="text-gray-700 leading-relaxed font-sf-pro-text text-justify">
                    ...
                    mind, a question to ask, or just want to say hello our team
                    is ready to connect and help you bring your ideas to life
                  </p>
                </motion.div>
              </motion.div>
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <motion.div className="w-[85%]" variants={containerVariants}>
              <motion.form
