        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {displayedCapabilities.map((capability, index) => (
            <a
              ...
              className={`group relative h-100 rounded-2xl overflow-hidden shadow-lg border border-white/10 bg-cover bg-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
              style={{
