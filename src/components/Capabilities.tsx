...
<section
  id="capabilities"
  className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-12"
>
  <div className="bg-black text-white w-full h-auto rounded-xl flex items-center justify-center p-6 sm:p-8 md:p-10">
